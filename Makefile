...
OBJS+=src/main.o
OBJS+=src/usb_device.o src/usbd_cdc_if.o src/usbd_desc.o src/lps25h.o src/led.o src/cfg.o src/wifi_config.o src/wifi_function.o src/malloc.o src/cJSON.o
